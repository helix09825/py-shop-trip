...
def shop_trip() -> None:
    ...
    for customer in shop_manager.customers:
        ...
        # Find the cheapest trip by sorting the options.
        cheapest_shop_name, cheapest_cost = sorted(
        ...
        # Find the data for the chosen shop.
        chosen_shop: dict[str, Any] = next(
        ...
        for product, quantity in customer.product_cart.items():
            unit_price = chosen_shop["products"][product]
